...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($resultado === true) {
        ...
        if ($_SESSION['usuario_tipo'] == 'aluno') {
            header("Location: lista_vagas_usuario.html");  // Página para Aluno
        } elseif ($_SESSION['usuario_tipo'] == 'egresso') {
            header("Location: lista_indicacoes_egresso.html");  // Página para Egresso
        } elseif ($_SESSION['usuario_tipo'] == 'empresa') {
            header("Location: lista_vagas_empresa.html");  // Página para Empresa
        }
        exit;
    } else {
