          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php echo ucwords(htmlspecialchars($vaga['nome_etapa'])); ?>
                </td>
                <td>
                  <?php echo htmlspecialchars($vaga['total_inscricoes']); ?>
                </td>
                <td class="buttons">
                  <button
                    onclick="visualizarVaga(<?php echo($vaga['idvaga']); ?>)"
                  >
                    Visualizar vaga
                  </button>
                  <button
                    onclick="removerVaga(<?php echo($vaga['idvaga']); ?>)"
                  >
                    Remover vaga
                  </button>
                </td>
